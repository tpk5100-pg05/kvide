  ...
  return (
    <>
      ...
      <Card sx={{ mt: 3, mb: 3, pl: 5, pr: 5, overflow: 'scroll' }}>
        ...
        <h3>History page:</h3>
        <p>
          On this page you can see the history of all your documented episodes, from the most recent
          to the oldest.{' '}
        </p>
        ...
        <p>
          On this page you can add, edit and delete different treatment options, like specific types
          of medicine or getting some sleep. These options will then become available as an option
          when adding an option.{' '}
        </p>

        <h3>Symptoms page:</h3>
        <p>
          On this page you can add, edit and delete different symptoms when an episode occurs. These
          options will then become available as an option when adding an option.{' '}
        </p>
